...
//     if (imagesFromUpload.length) {
//       employee.images = imagesFromUpload; // replace with newly uploaded set
//     }
//     if (profileFromUpload) {
//       employee.profileImage = profileFromUpload; // replace with newly uploaded file
//     }
